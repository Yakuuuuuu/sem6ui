...
const Cart = ({ isOpen, onClose }: CartProps) => {
  ...
  const handleQuantityChange = (id: number, newQuantity: number, productName: string) => {
                  ...
                  {cartItems.map((item) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="text-red-500 hover:text-red-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 rounded p-1"
