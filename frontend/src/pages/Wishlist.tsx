        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {wishlist.length > 0 ? (
            ...
            <div className="text-center py-24 flex flex-col items-center justify-center">
              <Heart className="h-20 w-20 text-gray-200 mx-auto mb-6" />
              <h2 className="text-2xl font-semibold text-gray-700 mb-2">Your wishlist is empty</h2>
              <p className="text-gray-500 mb-6">Save items you love to your wishlist and shop them anytime!</p>
              <a
                href="/"
                className="inline-block px-8 py-3 bg-black text-white rounded-full hover:bg-gray-900 transition-colors font-semibold shadow"
              >
                Continue Shopping
              </a>
            </div>
