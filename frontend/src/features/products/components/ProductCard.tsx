    ...
    >
      <div className="relative overflow-hidden">
        ...
        >
          ...
          <button
            ...
            aria-label={`Add ${product.name} to cart for रू${toNPR(product.price)}`}
          >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          <span className="text-xl font-bold text-gray-900" aria-label={`Price: रू${toNPR(product.price)}`}>
            रू{toNPR(product.price)}
          </span>
